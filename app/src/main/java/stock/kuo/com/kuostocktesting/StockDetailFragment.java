package stock.kuo.com.kuostocktesting;
...
import stock.kuo.com.kuostocktesting.dummy.DummyContent;
...
public class StockDetailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mItem != null) {
            ((TextView) rootView.findViewById(R.id.stock_detail)).setText(mItem.content);
        }
